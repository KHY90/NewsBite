      ...
      <div className="max-w-md w-full">
        <div className="card p-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">구글 계정으로 10초 만에 시작하세요.</p>
          </div>
          ...
          <div className="mt-6 text-xs text-gray-500 text-center">
            로그인 시 NewsBite의 <a href="#" className="text-gray-600 hover:underline">이용약관</a> 및 <a href="#" className="text-gray-600 hover:underline">개인정보처리방침</a>에 동의하는 것으로 간주됩니다.
          </div>
        </div>
      </div>
    </div>
